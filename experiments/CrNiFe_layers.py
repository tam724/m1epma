...
elements = [physics.Chromium(), physics.Nickel(), physics.Iron()]
...
true_parameters = np.array(
    [
        np.random.dirichlet([1/3, 1/3, 1/3], 10)[:, 0:2]
    ]
).reshape((material.n_x, material.n_y, 2))
true_parameters[0, :, 0] = 0.0
true_parameters[0, :, 1] = 0.0
true_parameters[1, :, 0] = 0.0
true_parameters[1, :, 1] = 0.0
true_parameters[-2, :, 0] = 0.0
true_parameters[-2, :, 1] = 0.0
true_parameters[-1, :, 0] = 0.0
true_parameters[-1, :, 1] = 0.0
...
variable_parameters = [(2, 0, 0), (2, 0, 1), (3, 0, 0), (3, 0, 1), (4, 0, 0), (4, 0, 1), (5, 0, 0), (5, 0, 1), (6, 0, 0), (6, 0, 1), (7, 0, 0), (7, 0, 1)]
...
for (p, conn) in procs:
    p.terminate()
with open('CrNiFe_layers.pkl', 'wb') as writefile:
