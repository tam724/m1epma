...
mat, par = build_material_and_parameters(0., 25/7 * 250/2*nano)

k_ratios = []
for idx, e_beam_position in enumerate(np.linspace(-25/7*250./2.*nano, 25./7.*250./2.*nano, 126)):
    material, true_parameters = build_material_and_parameters(e_beam_position, 25/7 * 250/2*nano)
...
with open('experiments/FeMnTi_new_density.pkl', 'wb') as writefile:
...
for std in ["MnTi", "Fe"]:
    if std == "Fe":
        material = physics.Material(
            ...
            hat_n_x = 250,
            hat_n_y = 175,
            dim_x = [- 25/7 * 250/2*nano, 25/7 * 250/2*nano],
            dim_y = [-25/7 * 250/2*nano, 0.]
        )
    elif std == "MnTi":
        material = physics.Material(
            n_x = 350,
            ...
            hat_n_x = 350,
            hat_n_y = 175,
            dim_x = [- 25/7 * 350/2*nano, 25/7 * 350/2*nano],
            dim_y = [-25/7 * 350/2*nano, 0.]
        )
