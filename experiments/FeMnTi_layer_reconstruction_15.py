...
true_parameters[22, :, 0] = 0.0
true_parameters[22, :, 1] = 0.6

std_parameters_MnTi = np.zeros(e.parameter_dimensions)
std_parameters_MnTi[:, :, 1] = 0.8
...
i_std_MnTi = m1epma_parallel.compute_k_ratios_async(n_k_ratios, [std_parameters_MnTi], 3, procs, True)
